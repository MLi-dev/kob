                        ...
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-model="botadd.description" class="form-control" id="add-bot-description" rows="3" placeholder="Please enter bot description"/>
                                </div>
                                <div class="mb-3">
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="add-bot-description" class="form-label">Introduction</label>
                                                        <textarea v-model="bot.description" class="form-control" id="add-bot-description" rows="3" placeholder="Please enter Bot profile"></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="add-bot-code" class="form-label">The Code</label>
                                                        <VAceEditor
